// ignore_for_file: prefer_if_null_operators, unused_element, depend_on_referenced_packages, implementation_imports
...
class PushButtonState extends State<PushButton> with SingleTickerProviderStateMixin {
  @override
  ...
  AccentColor get _accentColor => AccentColorListener.instance.currentAccentColor ?? AccentColor.blue;
  ...
  BoxDecoration _getClickEffectBoxDecoration() {
    ...
    final color = isDark ? const MacosColor.fromRGBO(255, 255, 255, 0.15) : const MacosColor.fromRGBO(0, 0, 0, 0.06);
              ...
              builder: (context, _) {
                return StreamBuilder<bool>(
                  ...
                  builder: (context, _) {
                    ...
                    return DecoratedBox(
                      decoration: _getBoxDecoration().copyWith(borderRadius: widget.controlSize.borderRadius),
                      child: Container(
                        foregroundDecoration: buttonHeldDown ? _getClickEffectBoxDecoration() : const BoxDecoration(),
